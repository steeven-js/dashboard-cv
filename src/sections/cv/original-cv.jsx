  ...
  <Paper sx={{ p: 4, maxWidth: '800px', mx: 'auto' }}>
    ...
    <Box sx={{ mb: 4 }}>
      ...
      <Typography>
        ...
        SQL/NoSQL. Passionné par l&apos;architecture logicielle, les bonnes pratiques de
    ...
    <Box sx={{ mb: 4 }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Box sx={{ pl: 2, mt: 1 }}>
          <Typography sx={{ mb: 0.5 }}>
            • Développement et maintenance d&apos;une plateforme SaaS B2B utilisée par plus de 50
            000 utilisateurs
          </Typography>
          <Typography sx={{ mb: 0.5 }}>
            • Mise en œuvre d&apos;une architecture microservices avec Node.js et Docker, réduisant
            les temps de déploiement de 70%
          </Typography>
          <Typography sx={{ mb: 0.5 }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Box sx={{ pl: 2, mt: 1 }}>
          <Typography sx={{ mb: 0.5 }}>
            • Développement d&apos;applications web responsive pour divers clients dans les secteurs
            de la finance et du e-commerce
          </Typography>
          <Typography sx={{ mb: 0.5 }}>
          ...
          <Typography sx={{ mb: 0.5 }}>
            • Optimisation des performances front-end, réduisant le temps de chargement des pages de
            40%
          </Typography>
        </Box>
      </Box>
    ...
    <Box sx={{ mb: 4 }}>
      ...
      <Box sx={{ mb: 2 }}>
        ...
        <Typography sx={{ mt: 1 }}>Option Programmation et Algorithmique. Mention Bien.</Typography>
      </Box>
    </Box>
